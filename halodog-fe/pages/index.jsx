  ...
  return (
    ...
    "Ketahui Penyakit Hewan Peliharaanmu Di sini"
      ...
      <Link href="/auth/register">
                <h2 className="text-2xl text-black font-bold block bg-red-500 px-8 py-4 rounded-lg text-2xl font-bold hover:bg-blue-800 transition duration-300">
                  Check ur pet diseases
                </h2>
      </Link>
      </div>
      </div>
