    ...
    <div className='h-[100vh]'>
         <div className="flex items-center h-full justify-center">
            <form className="w-[776px] h-[719px] bg-[#FFFF] flex flex-col items-center justify-center rounded-[12px] ml-[-10px] border-2">
                <p className="font-poppins font-[900] text-[36px] mb-[90px]">Register</p>
                <input type="text" name="name" className="border-2 w-[300px] h-[40px] font-poppins mb-[20px] px-[10px] rounded-[12px] text-black" placeholder="name" onChange={(e) => setNama(e.target.value)} />
                ...
                <button type="button" className="bg-[#0066FF] w-[200px] rounded-[12px] text-white font-bold py-[5px]" name="login" onClick={handleSubmit} >Register</button>
            </form>
         </div>
